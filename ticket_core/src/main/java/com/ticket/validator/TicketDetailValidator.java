...
public void validateCloseTicket(int id,int userId) throws ValidatorException{
...
public void validateReassignTicket(int ticketId,int empId) throws ValidatorException{
	validatorUtil.rejectIfNegativeOrZeroOrNull(ticketId, "ticketId");
...
public void validateEmpId(int empId) throws ValidatorException{
	validatorUtil.rejectIfNegativeOrZeroOrNull(empId, "Emp_Id");
}
public void validatedelete(int empId,int ticketId) throws ValidatorException{
validatorUtil.rejectIfNegativeOrZeroOrNull(empId, "empId");
validatorUtil.rejectIfNegativeOrZeroOrNull(ticketId, "ticketId");
}
}
